...
from pydantic_extracter.burns.burns_template import get_extraction_prompt_template # Import the prompt template function
...
EXTRACTION_PROMPT_TEMPLATE = get_extraction_prompt_template()
